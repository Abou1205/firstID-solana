...
import {
  Metaplex, keypairIdentity, bundlrStorage, toMetaplexFile, findMetadataPda, } from "@metaplex-foundation/js"
...
async function createTokenMetadata(
  ...
  // file to buffer
  const buffer = fs.readFileSync("assets/kitten.png")

  // buffer to metaplex file
  const file = toMetaplexFile(buffer, "kitten.png")
...
async function main() {
  ...
  const MINT_ADDRESS = "4fsth8GqmQmjQkc5QaY9cqYxKvWbH5asUCz7iydN7rEZ"
